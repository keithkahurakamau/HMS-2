...
export const JOURNEYS = {
    ...
    payhero: [
        { title: 'M-Pesa Payments',
          body: "Connect your hospital's Safaricom till so you can collect M-Pesa at the till and pharmacy.",
          placement: 'center' },
        { title: 'Step 1 — enter your shortcode',
          body: "Type the PayBill or Buy-Goods Till you already own, and pick its type. That's the only number you need.",
          placement: 'center' },
        { title: 'Step 2 — choose your settlement bank',
          body: 'Select the bank + account where your M-Pesa proceeds settle. Save when done.',
          placement: 'center' },
        { title: 'Step 3 — MediFleet activates it',
          body: "MediFleet finishes activation on its end. Once the status shows M-Pesa is live, send a KES 1 test prompt to your own phone to confirm.",
          placement: 'center' },
    ],
