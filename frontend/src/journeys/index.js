...
export const JOURNEYS = {
    ...
    billing: [
        ...
        { selector: '[data-tour="billing-mpesa"]',
          ...
          body: "Every M-Pesa payment is logged here with receipt number and payer phone. Match against your Pay Hero dashboard at close.",
          placement: 'top' },
    ],
    ...
    payhero: [
        { title: 'Pay Hero (M-Pesa) configuration',
          body: "Per-tenant Pay Hero credentials and a test STK push to confirm wiring.",
          placement: 'center' },
        { selector: '[data-tour="payhero-config"]',
          title: 'Step 1 — enter credentials',
          body: "Channel ID, username, password. Encrypted at rest with the platform's Fernet key — never returned to the browser in plaintext.",
          placement: 'top' },
        { selector: '[data-tour="payhero-test"]',
          title: 'Step 2 — send a test STK',
          body: 'Phone number + KES 1 → click Test. Walk through the full round-trip to confirm the callback lands and the payment posts.',
          placement: 'top' },
        { selector: '[data-tour="payhero-unmatched"]',
          title: 'Step 3 — handle unmatched callbacks',
          body: "Callback arrives but the reference doesn't match an invoice? Lands here for manual assignment.",
          placement: 'top' },
    ],
